	...
	CSF::createSection($prefix, array(
		...
		'fields' => array(
		  array(
			...
			'type' => 'group',
			'title' => 'Badges',
				'button_title' => 'Add Badge',
				'remove_title' => 'Remove Badge',
			'fields' => array(
				array(
				  'id' => 'badge_title',
				  'type' => 'text',
				...
				array(
				  ...
				  'title' => 'Link',
				  'subtitle' => 'Optional',
				  'desc' => 'Add full URL address - https://example.com',
				),
				array(
				  'id'       => 'custom_badge_switcher',
				  'type'     => 'switcher',
				  'title'    => 'Enable .SVG Badge',
				  'text_on'  => 'Yes',
				  'text_off' => 'No',
				  'default'  => false,
				),
			  array(
					...
					'button_title' => "Upload Badge",
					'dependency'    => array('custom_badge_switcher', '==', false),
			  ) ,
			  array(
					'id' => 'badge-webp',
					'type' => 'media',
					'title' => 'Badge (WebP) - Optional',
					'library' => 'image',
					'placeholder' => 'No Badge Selected',
					'button_title' => "Upload Badge",
					'desc' => 'Allowed Image Formats: webp.',
				...
				array(
				  ...
				  'type'  => 'code_editor',
				  'title' => 'SVG Badge',
				  'dependency'    => array('custom_badge_switcher', '==', true),
				),
			)
		  ) ,
		)
	...
	CSF::createSection($prefix, array(
		...
		'fields' => array(
		  array(
				...
				'type' => 'group',
				'title' => 'Case Results',
				'button_title' => 'Add Case',
				'remove_title' => 'Remove Case',
				'fields' => array(
				array(
				  'id' => 'field_1',
				  'type' => 'text',
